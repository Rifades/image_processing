...
# ==========================================
IMGBB_API_KEY = "20eab0dd20d4cdc0c594fadb8e833728"  # <-- Paste your API key inside these quotes
        ...
        with col2:
            ...
            with dl_col3:
                if st.button("🔗 Create Shareable Link", use_container_width=True):
                    if IMGBB_API_KEY == "PASTE_YOUR_IMGBB_API_KEY_HERE" or not IMGBB_API_KEY.strip():
                        st.error("Please hardcode your valid ImgBB API key at the top of the script!")
                    else:
